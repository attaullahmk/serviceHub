...
// this for notafication and socket io
// const { users, io } = require("../server");  // Import users and io from server.js
// console.log("this user",users, io)
// const Message = require("../models/message"); // Assuming Message model exists
...
// const ExpressError = require("../utils/ExpressError"); // Assuming ExpressError utility exists
...
//     const notificationContent = `New message from ${sender.name}: ${content}`;
//     const notification = new Notification({
//       user: receiver, // The receiver will get the notification
//       message: message._id,
