...
async function seedAdmin() {
  ...
  const existingAdmin = await Admin.findOne({ email: "attaullahmk47@gmail.com" });
  ...
  const defaultAdmin = new Admin({
    name: "attaullah",
    email: "attaullahmk47@gmail.com",
    password: "admin123", // will be hashed automatically
    permissions: ["manage-users", "manage-services", "view-dashboard"],
  });
